...
public class ConfigScreen extends Component {
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // "Your profiles" text
        VapeMenu.getFontRenderer().drawString(matrices, "Your Profiles", pX + 20, pY + 50, Theme.MODULE_TEXT.getRGB());
        // Blue underline
        ...
        for(Config config : ConfigLoader.getConfigs()) {
            ...
            if(isConfigAdded && config == ConfigLoader.lastAddedConfig) {
                if(createNewAnimX != null && createNewAnimY != null) {
                    ...
                    VapeMenu.getFontRenderer().drawString(matrices, config.getName(), createNewAnimX.getValue() + 5, createNewAnimY.getValue() + 5, -1);
                ...
                if (config == VapeMenu.getInstance().selectedConfig) {
                ...
                VapeMenu.getFontRenderer().drawString(matrices, config.getName(), pX + offsetX + 25, pY + 80 + offsetY, -1);
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        for(Config config : ConfigLoader.getConfigs()) {
            ...
            if(isHovered(pX + offsetX + 17, pY + 72 + offsetY, pX + 103 + offsetX, pY + 158 + offsetY, mouseX, mouseY) && button == 0) {
                ...
                VapeMenu.getInstance().selectedConfig = config;
